...
<section class="content-header content-header-custom tw-font-sans">
    <h1>{{ __('home.welcome_message', ['name' => Session::get('user.first_name')]) }}
    </h1>
</section>
<!-- Main content -->
<section class="content content-custom no-print tw-font-sans ">
    <br>
...
<!-- /.content -->
<div class="modal fade payment_modal tw-font-sans" tabindex="-1" role="dialog" 
    aria-labelledby="gridSystemModalLabel">
</div>
<div class="modal fade edit_pso_status_modal tw-font-sans" tabindex="-1" role="dialog"></div>
<div class="modal fade edit_payment_modal tw-font-sans" tabindex="-1" role="dialog" 
    aria-labelledby="gridSystemModalLabel">
</div>
@stop
@section('javascript')
